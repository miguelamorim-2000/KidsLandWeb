...
function editvalidation(){
    ...
    if(nif == ''){
        Swal.fire(
            '',
            'Por favor, indique o nif da instituição',
            'error'
        );
    ...
    if(address == ''){
        Swal.fire(
            '',
            'Indique a morada da instituição',
            'error'
            );
    ...
    if(county == ''){
        Swal.fire(
            '',
            'Por favor, indique a respetiva localidade da instituição',
            'error'
        );
    ...
    if(district == ''){
        Swal.fire(
            '',
            'Por favor, indique o respetivo distrito da instituição',
            'error'
        );
